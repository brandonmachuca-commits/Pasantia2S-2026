...
OUTPUT_DIR = Path(__file__).parent.parent.parent / "data" / "raw" / "calendario"
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

OUTPUT_FILE = OUTPUT_DIR / "calendario.docx"
...
def main():
    ...
    print("[INFO] Descargando página de calendario...")

    url = obtener_url_pagina("calendario")
